...
public class MachineRemove implements Listener {
	...
	private void onBlockBreak(BlockBreakEvent e) {
		...
		else if (e.getBlock().getType().equals(Material.DISPENSER) && ((Nameable) e.getBlock().getState()).getCustomName().equals(ItemExtractor.itemExtractor2().getItemMeta().getDisplayName())) {
			e.setDropItems(false);
			List<Entity> nearbyEntites = (List<Entity>) e.getBlock().getWorld().getNearbyEntities(e.getBlock().getLocation().add(0.5, 0.02, 0.5), 0.01, 0.01, 0.01);
			nearbyEntites.get(0).remove();
			e.setDropItems(false);
		...
		else if (e.getBlock().getType().equals(Material.DISPENSER) && ((Nameable) e.getBlock().getState()).getCustomName().equals(ItemExtractor.itemExtractor3().getItemMeta().getDisplayName())) {
			e.setDropItems(false);
			List<Entity> nearbyEntites = (List<Entity>) e.getBlock().getWorld().getNearbyEntities(e.getBlock().getLocation().add(0.5, 0.02, 0.5), 0.01, 0.01, 0.01);
			nearbyEntites.get(0).remove();
			e.getBlock().getWorld().dropItemNaturally(e.getBlock().getLocation(), ItemExtractor.itemExtractor3());
		}
		else if (e.getBlock().getType().equals(Material.DISPENSER) && ((Nameable) e.getBlock().getState()).getCustomName().equals(ItemExtractor.itemExtractor4().getItemMeta().getDisplayName())) {
			e.setDropItems(false);
			List<Entity> nearbyEntites = (List<Entity>) e.getBlock().getWorld().getNearbyEntities(e.getBlock().getLocation().add(0.5, 0.02, 0.5), 0.01, 0.01, 0.01);
			nearbyEntites.get(0).remove();
		...
		else if (e.getBlock().getType().equals(Material.BEACON) && ((Nameable) e.getBlock().getState()).getCustomName().equals(MineBuilder.mineBuilder1().getItemMeta().getDisplayName())) {
			e.setDropItems(false);
		...
		else if (e.getBlock().getType().equals(Material.BEACON) && ((Nameable) e.getBlock().getState()).getCustomName().equals(MineBuilder.mineBuilder2().getItemMeta().getDisplayName())) {
			e.setDropItems(false);
			List<Entity> nearbyEntites = (List<Entity>) e.getBlock().getWorld().getNearbyEntities(e.getBlock().getLocation().add(0.5, -0.15, 0.5), 0.01, 0.01, 0.01);
			nearbyEntites.get(0).remove();
		...
		else if (e.getBlock().getType().equals(Material.BEACON) && ((Nameable) e.getBlock().getState()).getCustomName().equals(MineBuilder.mineBuilder3().getItemMeta().getDisplayName())) {
			e.setDropItems(false);
			List<Entity> nearbyEntites = (List<Entity>) e.getBlock().getWorld().getNearbyEntities(e.getBlock().getLocation().add(0.5, -0.15, 0.5), 0.01, 0.01, 0.01);
			nearbyEntites.get(0).remove();
		...
		else if (e.getBlock().getType().equals(Material.BEACON) && ((Nameable) e.getBlock().getState()).getCustomName().equals(MineBuilder.mineBuilder4().getItemMeta().getDisplayName())) {
			e.setDropItems(false);
			List<Entity> nearbyEntites = (List<Entity>) e.getBlock().getWorld().getNearbyEntities(e.getBlock().getLocation().add(0.5, -0.15, 0.5), 0.01, 0.01, 0.01);
			nearbyEntites.get(0).remove();
